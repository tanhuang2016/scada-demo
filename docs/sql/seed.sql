...
-- RTU001：城南配电站一号开关终端（JSON 协议，迭代 2 演示用）
('RTU001', '城南配电站一号开关终端', '配电终端', '城南配电站', '一区',
 '10kV', '演示设备 - 10kV 线路采集', '127.0.0.1', 5001, 'JSON',
 1, 1, 1, 1),

-- RTU002：城南配电站二号开关终端（IEC104 预留，演示"未实现"跳过）
('RTU002', '城南配电站二号开关终端', '配电终端', '城南配电站', '一区',
 '10kV', '演示设备 - 10kV 线路采集', '127.0.0.1', 2404, 'IEC104',
 2, 2, 1, 2),

-- RTU003：城北环网柜A柜终端（IEC104 预留，演示"未实现"跳过）
('RTU003', '城北环网柜A柜终端', '环网柜', '城北环网柜', '二区',
 '10kV', '演示设备 - 环网柜采集', '127.0.0.1', 2404, 'IEC104',
 3, 3, 1, 3);
